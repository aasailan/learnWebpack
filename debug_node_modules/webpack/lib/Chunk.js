...
// 一个chunk对象，后续对应会生成一个文件
class Chunk {

 /**
  * Creates an instance of Chunk.
  * @param {string} name chunk名字
  * @param {Module} module module对象
  * @param {*} loc
  * @memberof Chunk
  */
 constructor(name, module, loc) {
  ...
  // 当前chunk是否有webpack runtime;当前chunk的entrypoints不为空则是entry chunk
	hasRuntime() {
 ...
 /**
  * @description 向chunk内存储一个module
  * @param {*} module
  * @returns {boolean} 新添加一个module返回ture，已存在module则返回false
  * @memberof Chunk
  */
 addModule(module) {
